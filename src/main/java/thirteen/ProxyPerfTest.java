...
public class ProxyPerfTest {
    public static void main(String... args){
        ...
        runCglibTestes(advisor,target);
        runCglibFrozenTestes(advisor,target);
        runJdkTests(advisor,target);

    }
    private static void runCglibTestes(Advisor advisor,SimpleBean target){
    ...
    private static void runCglibFrozenTestes(Advisor advisor,SimpleBean targer){
        ProxyFactory pf = new ProxyFactory();
        pf.setProxyTargetClass(true);
        pf.setTarget(targer);
        pf.addAdvisor(advisor);
